...
```jsx
// âŒ Bad: Assumes short English text
<button className="w-24">Submit</button>

// âœ… Good: Adapts to content
...
```javascript
// âœ… Use Intl API for proper formatting
...
**Pluralization**:
```javascript
// âŒ Bad: Assumes English pluralization
`${count} item${count !== 1 ? 's' : ''}`

// âœ… Good: Use proper i18n library
