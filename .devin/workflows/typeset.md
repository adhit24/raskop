...
Assess and improve typography that feels generic, inconsistent, or poorly structured â€” turning default-looking text into intentional, well-crafted type.
...
**CRITICAL**: The goal isn't to make text "fancier" â€” it's to make it clearer, more readable, and more intentional. Good typography is invisible; bad typography is distracting.
...
- **Weight strategy**: Which weights serve which roles? (Regular for body, Semibold for labels, Bold for headings â€” or whatever fits)
...
- Pair with genuine contrast (serif + sans, geometric + humanist) â€” or use a single family in multiple weights
...
- **Combine dimensions**: Size + weight + color + space for strong hierarchy â€” don't rely on size alone
...
- Pick sizes arbitrarily â€” commit to a scale
- Set body text below 16px
- Use decorative/display fonts for body text
- Disable browser zoom (`user-scalable=no`)
- Use `px` for font sizes â€” use `rem` to respect user settings
...
Remember: Typography is the foundation of interface design â€” it carries the majority of information. Getting it right is the highest-leverage improvement you can make.
