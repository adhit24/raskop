...
Invoke /impeccable â€” it contains design principles, anti-patterns, and the **Context Gathering Protocol**. Follow the protocol before proceeding â€” if no design context exists yet, you MUST run /impeccable teach first. Additionally gather: quality bar (MVP vs flagship).
...
- **Tinted neutrals**: No pure gray or pure blackâ€”add subtle color tint (0.01 chroma)
- **Gray on color**: Never put gray text on colored backgroundsâ€”use a shade of that color or transparency
...
- **Consistent easing**: Use ease-out-quart/quint/expo for natural deceleration. Never bounce or elasticâ€”they feel dated.
